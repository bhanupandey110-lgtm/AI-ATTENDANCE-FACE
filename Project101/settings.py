...
TIME_ZONE = 'Asia/kolkata' # add kolkata for india timezone
...
STATIC_URL = 'static/'
# Optional: If you're not using the default static directory
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Update if necessary
]
...
WHITENOISE_IGNORE_REGEX = r'\.(map|png|woff2?|ttf|eot)$'
